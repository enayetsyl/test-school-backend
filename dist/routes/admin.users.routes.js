...
import { listUsersCtrl, getUserCtrl, createUserCtrl, updateUserCtrl, } from '../controllers/admin.users.controller';
import { ListUsersQuery, UserIdParams, CreateUserSchema, UpdateUserSchema, } from '../validators/admin.users.validators';
const router = Router();
